...
<div class="modal" id="medicalhistory">
			...
			<div class="inner_section">
				<div id="record_container" class="record_container">
								<h3 class="title">RALPH OKONO'S CLINIC</h3><br>
								Phone: +254976066047<br>
								Email: ralph.osiko@strathmore.edu		
...
<div class="modal" id="medicaltreatment">
			...
			<div class="inner_section">
				<div id="record_container" class="record_container">
								<h3 class="title">RALPH OKONO'S</h3><br>
...
<body class="cbp-spmenu-push">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="header" style="margin-top:10px">
              	 ...
              	 <h4>RALPH'S ELECTRONIC MEDICAL RECORDS</h4>
              </li>
                <?php
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="https://www.patrickmvuma.com" target="">Design and Developed by Ralph Okono</a></p>		
	</div>
    <!--//footer-->
	</div>
